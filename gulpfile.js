...
.task('font', function () {
    gulp.src('_front/scss/fonts/**/*.{eot,svg,ttf,woff,woff2}')
...
.task('watch', function () {
    ...
    gulp.watch('_front/scss/**/*.scss', ['css']);
    gulp.watch('_front/scss/fonts/**/*.{eot,svg,ttf,woff,woff2}', ['font']);
    gulp.watch('_front/js/**/*.js', ['scripts']);
    gulp.watch('_front/img/**/*', ['imgMin']);
})

.task('default', ['jade', 'css', 'font', 'scripts', 'imgMin', 'browser-sync', 'watch']);